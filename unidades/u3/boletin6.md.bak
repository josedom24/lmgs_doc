...
7. Puedes realizar el ejercicio anterior de otra forma, puedes plantear una solución de "fuerza bruta"que consiste en ir construyendo palabras cada vez más complejas:
...
8. Escribe un programa para jugar al ahorcado.
